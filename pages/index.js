    ...
    <>
      <Layout>
        ...
        <section className='items-center flex flex-col p-4'>
          ...
          <p className='text-lg  p-2 font-semi'>
            I am a software developer who likes to create beautiful digital
            products.
          </p>
        </section>
        <h2 className='p-4 text-2xl underline text-indigo-600'> Blog Posts</h2>
